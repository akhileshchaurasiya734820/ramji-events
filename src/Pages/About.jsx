      ...
      <div className="about-header-banner">
        <div className="about-header-content">
          ...
          <p className="about-lead">
            From a two-person studio in Mumbai to India's most trusted event company — this is our story.
          </p>
        </div>
      </div>
          ...
          <div className="about-story-content-grid">
            ...
            <div className="about-story-left">
              ...
              <p className="about-story-desc">
                In 2002, Ramesh Joshi had one conviction: every celebration deserves to be extraordinary. Starting with a small team of three in Andheri, Mumbai, Ramji Events grew organically — client by client, memory by memory.
              </p>
              <p className="about-story-desc">
